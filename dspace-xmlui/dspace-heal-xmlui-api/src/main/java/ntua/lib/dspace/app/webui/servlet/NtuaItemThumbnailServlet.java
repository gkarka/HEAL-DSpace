...
import org.dspace.app.webui.servlet.RetrieveServlet;
...
public class NtuaItemThumbnailServlet
  ...
  protected void doDSGet(Context context,
    ...
    if (idString != null) {
      ...
      if (slashIndex != -1) {
        itemIndex = idString.substring(slashIndex + 1);
...
//      synchronized (tarutil)
//      {
        tarutil.writeThumbnail(Integer.parseInt(itemIndex), response.getOutputStream());
//      }
    }
    else {
