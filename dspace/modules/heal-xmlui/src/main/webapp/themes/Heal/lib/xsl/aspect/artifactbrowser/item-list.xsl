            ...
            <div class="artifact-preview">
                <a class="image-link" href="{$href}">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                          <img alt="[Ιtem]" src="{concat($theme-path, '/images/mimes/text.png')}" style="height: 48px;" width="48" height="48" title="Item"/>
                            <!--<img alt="Icon" src="{concat($theme-path, '/images/mimes/pdf.png')}" style="height: {$thumbnail.maxheight}px;"/>-->
                        </xsl:otherwise>
                    </xsl:choose>
                </a>
            </div>
