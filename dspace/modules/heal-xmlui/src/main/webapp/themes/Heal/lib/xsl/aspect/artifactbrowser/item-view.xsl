                ...
                <a class="image-link">
                    ...
                    <xsl:choose>
                      ...
                      <xsl:when test="@MIMETYPE = 'application/pdf'">
                        ...
                        <!--<xsl:when test="mets:FLocat/@xlink:title, '.kar')">-->
                        <xsl:when test="@MIMETYPE = 'application/octet-stream'">
                            <img alt="[HTML]" src="{concat($theme-path, '/images/mimes/kar.png')}" style="height: 48px;" width="48" height="48" title="HTML file"/>
                        </xsl:when>
                        <xsl:otherwise>
                          <img alt="[Text]" src="{concat($theme-path, '/images/mimes/unknown.png')}" style="height: 48px;" width="48" height="48" title="Text file"/>
                            <!--<img alt="[File]" src="{concat($theme-path, '/images/mime.png')}" style="height: {$thumbnail.maxheight}px;"/>-->
                        </xsl:otherwise>
                    </xsl:choose>
                </a>
            </div>
